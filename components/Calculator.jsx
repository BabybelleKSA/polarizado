    ...
    <div className="glass-card rounded-3xl p-6 sm:p-7 shadow-[0_24px_80px_rgba(0,0,0,0.55)] flex flex-col gap-6 fade-up border border-white/10">
      <header className="flex items-center justify-between gap-3">
        <div className="space-y-1">
          <p className="text-xs uppercase tracking-[0.32em] text-white/60">Instant Estimate</p>
          <h2 className="text-2xl font-semibold text-white">Tint Price Calculator</h2>
        </div>
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-3 text-sm font-semibold text-white/80">
          <div className="flex items-center justify-between">
            <span className="text-white">Tint Percentage</span>
            <span className="text-[11px] uppercase tracking-[0.2em] text-white/50">% Shade</span>
          </div>
      ...
      <div className="relative overflow-hidden rounded-2xl border border-white/12 bg-gradient-to-br from-black via-white/5 to-black px-6 py-6 flex flex-col items-center text-center gap-2 soft-border">
        ...
        <p className="text-[11px] uppercase tracking-[0.3em] text-white/60">Estimated Price</p>
        <div
        ...
        <p className="text-sm text-white/70">Based on your vehicle &amp; shade selection.</p>
      </div>
    </div>
  );
}
